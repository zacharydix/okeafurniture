...
insert into ItemCategory (ItemId, CategoryId) values (1,2);
insert into ItemCategory (ItemId, CategoryId) values (2,10);
insert into ItemCategory (ItemId, CategoryId) values (3,15);
insert into ItemCategory (ItemId, CategoryId) values (4,8);